...
const PartnersPage = () => {
  ...
  return (
    <Layout>
      <SEO title={t.seo.partnersTitle} description={t.seo.partnersDesc} />
      <PageHero label={t.partners.label} title={t.partners.title} subtitle={t.partners.subtitle} image={partnersHero} size="compact" />
