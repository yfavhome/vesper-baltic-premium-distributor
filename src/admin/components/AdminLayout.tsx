      ...
      <div className={`min-h-screen flex w-full ${dark ? "dark" : ""}`}>
        <div className="min-h-screen flex w-full bg-background text-foreground">
          ...
          <div className="flex-1 flex flex-col min-w-0">
            <header className="h-14 flex items-center gap-3 px-4 bg-card border-b border-border/50 sticky top-0 z-30">
            ...
            <main className="flex-1 p-4 md:p-6 lg:p-8 overflow-auto bg-secondary/30">
              <Outlet />
            </main>
          </div>
        </div>
